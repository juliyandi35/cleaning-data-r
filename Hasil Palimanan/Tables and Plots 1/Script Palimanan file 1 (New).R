...
setwd("D:/Kerjaan/Research Consultant/Project Cleaning Data mas Catur/Palimanan file 1")
folder_path <- "D:/Kerjaan/Research Consultant/Project Cleaning Data mas Catur/Palimanan file 1"
...
# Simpan workbook
saveWorkbook(wb, file = "Summary File Palimanan file 1.xlsx", overwrite = TRUE)
