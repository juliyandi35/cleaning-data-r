...
setwd("D:/Kerjaan/Research Consultant/Project Cleaning Data mas Catur/Cikopo file 1.3")
folder_path <- "D:/Kerjaan/Research Consultant/Project Cleaning Data mas Catur/Cikopo file 1.3"
...
# Simpan workbook
saveWorkbook(wb, file = "Summary File Cikopo file 1.3.xlsx", overwrite = TRUE)
