...
setwd("D:/Kerjaan/Research Consultant/Project Cleaning Data mas Catur/Cikopo file 1.2")
folder_path <- "D:/Kerjaan/Research Consultant/Project Cleaning Data mas Catur/Cikopo file 1.2"
...
# Simpan workbook
saveWorkbook(wb, file = "Summary File Cikopo file 1.2.xlsx", overwrite = TRUE)
